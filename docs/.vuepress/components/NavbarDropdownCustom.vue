...
import type { NavbarItem, ResolvedNavbarItem } from '@vuepress/theme-default/lib/shared/index.js'
...
<template>
  <div class="navbar-dropdown-wrapper" :class="{ open }">
    <button
      class="navbar-dropdown-title translate-dropdown"
      type="button"
    ...
    <button
      class="navbar-dropdown-title-mobile translate-dropdown"
      type="button"
      :aria-label="dropdownAriaLabel"
      @click="open = !open"
    >
